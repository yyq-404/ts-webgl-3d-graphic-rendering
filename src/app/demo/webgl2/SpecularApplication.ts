 ...
 * 镜面光应用。
 */
export class SpecularApplication extends WebGL2Application {
    /** 球体 */
    ...
    public override get shaderUrls(): Map<string, string> {
        return new Map<string, string>([
            ['bns.vert', `${AppConstants.webgl2ShaderRoot}/light/specular.vert`],
            ['bns.frag', `${AppConstants.webgl2ShaderRoot}/light/specular.frag`]
        ]);
    }
