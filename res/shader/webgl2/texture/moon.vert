...
void main() {
    ...
    //通过计算得到最终光照强度
    finalLightMoon = pointLight(normalize(aNormal), uLightLocationSun, vec4(0.05, 0.05, 0.025, 1.0), vec4(1.0, 1.0, 0.5, 1.0), vec4(0.3, 0.3, 0.15, 1.0));
    //将顶点的纹理坐标传给片元着色器
